# AntigravityPorter Deep Interview Context

## Task statement
Build a native macOS app called `AntigravityPorter` for Apple Silicon Macs.
...
- Workspace `/Users/z/Desktop/antigravityPorter` is greenfield: no source files currently exist, only `.omx` state/log directories.
- No workspace-scoped `AGENTS.md` exists under `/Users/z/Desktop/antigravityPorter`; user-provided AGENTS content governs this turn.
