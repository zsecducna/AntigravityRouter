...
final class ProxyCoreTests: XCTestCase {
    ...
    func testTransparentRoutingScriptsStayScopedToAntigravityHosts() {
        ...
        XCTAssertTrue(enable.contains("/etc/pf.anchors/com.antigravityrouter"))
        XCTAssertTrue(enable.contains("pfctl -nf"))
        XCTAssertTrue(enable.contains("rollback()"))
        XCTAssertTrue(enable.contains("com.antigravityrouter.token"))
        ...
        XCTAssertTrue(disable.contains("pfctl -a com.antigravityrouter -F all"))
        XCTAssertTrue(disable.contains("pfctl -X"))
        XCTAssertTrue(disable.contains("AntigravityRouter PF START"))
        XCTAssertTrue(disable.contains("AntigravityRouter START"))
    }
